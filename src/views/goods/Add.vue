<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <!-- 表单 -->
      <el-form :model="addGoodForm" :rules="GoodFormRules" ref="addGoodFormRef" class="demo-ruleForm" label-width="60px" label-position="top">
        <!-- tabs标签 -->
        <el-tabs tab-position="left" v-model="activeIndex" :before-leave="brforeTabLeave" @tab-click="tabClicked">
          <el-tab-pane label="基本信息" name="0">
            <el-form-item label="名称" prop="goods_name">
              <el-input v-model="addGoodForm.goods_name" autocomplete="off" clearable></el-input>
            </el-form-item>
            <el-form-item label="价格" prop="goods_price">
              <el-input v-model="addGoodForm.goods_price" autocomplete="off" clearable type="number"></el-input>
            </el-form-item>
            <el-form-item label="数量" prop="goods_number">
              <el-input v-model="addGoodForm.goods_number" autocomplete="off" clearable type="number"></el-input>
            </el-form-item>
            <el-form-item label="重量" prop="goods_weight">
              <el-input v-model="addGoodForm.goods_weight" autocomplete="off" clearable type="number"></el-input>
            </el-form-item>
            <!-- Cascader 级联选择器 -->
            <el-form-item label="分类" prop="goods_cat">
              <el-cascader v-model="addGoodForm.goods_cat" clearable @change="cascadeCateChange" :options="cateList" :props="cascaderProps"></el-cascader>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button style="margin: 15px 0" type="primary" @click="addGoods">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
  ...
  methods: {
    ...
    addGoods() {
      ...
      this.$refs.addGoodFormRef.validate(async (valid) => {
        ...
        // (form)
        const { data: res } = await this.$axios.post('shop/goods', form)
        // //(res)
